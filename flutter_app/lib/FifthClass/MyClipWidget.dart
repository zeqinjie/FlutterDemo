...
class MyClipWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => MyClipWidgetState();
}

class MyClipWidgetState extends State {
  ...
  * */
  Widget getCustomClipperWidget(){
    return DecoratedBox(
      ...
      child: ClipRect(
          clipper: MyCustomClipperWidget(), //使用自定义的clipper
          child: avatar
      ),
    );
  }
...
* */
class MyCustomClipperWidget extends CustomClipper<Rect> {
  @override
