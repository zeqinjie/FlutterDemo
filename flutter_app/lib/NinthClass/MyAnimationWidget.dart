...
class MyAnimationWidget extends StatefulWidget {
  ...
  @override
  _MyAnimationWidgetState createState() {
...
class _MyAnimationWidgetState extends State<MyAnimationWidget> with TickerProviderStateMixin {
  ...
  * */
  ...
  Widget getMyAnimatedImageWidget(){
    return MyAnimatedImage(animation: animation,);
  }
...
class MyAnimatedImage extends AnimatedWidget {
  MyAnimatedImage({Key key, Animation<double> animation}): super(key: key, listenable: animation);
