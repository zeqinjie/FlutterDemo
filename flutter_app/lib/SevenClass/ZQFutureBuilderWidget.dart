...
class ZQFutureBuilderWidget extends StatefulWidget {
  ZQFutureBuilderWidget({Key key}) : super(key: key);

  @override
  _ZQFutureBuilderWidgetState createState() {
    return _ZQFutureBuilderWidgetState();
  }
}

class _ZQFutureBuilderWidgetState extends State<ZQFutureBuilderWidget> {
