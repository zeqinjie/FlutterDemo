...
//第三章 Widget 简介
class ZQCounterWidget extends StatefulWidget{

  final int initValue;

  const ZQCounterWidget({
    Key key,
    this.initValue:0,
  });
  ...
  State<StatefulWidget> createState() {
    return _ZQCounterWidgetState();
  }
}

class _ZQCounterWidgetState extends State<ZQCounterWidget>{
...
//      ScaffoldState _state = Scaffold.of(context);
  ...
  void didUpdateWidget(ZQCounterWidget oldWidget) {
