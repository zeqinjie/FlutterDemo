...
class ZQScaffoldWidget extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => ZQScaffoldWidgetState();
}

//混入SingleTickerProviderStateMixin，为了传入vsync对象
class ZQScaffoldWidgetState extends State<ZQScaffoldWidget> with SingleTickerProviderStateMixin {
  int selectedIndex = 1;
...
//抽屉菜单Drawer
class ZQDrawerWidget extends StatelessWidget{

  const ZQDrawerWidget({Key key}):super(key:key);
